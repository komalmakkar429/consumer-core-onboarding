...
log_message "4. kubelogin"
log_message "5. Docker"
log_message "6. AWS CLI (v2 or higher)"
log_message "7. kubeconfig"
log_message "8. Vault"
log_message "9. kns (Kubernetes Namespace Switcher)"
log_message "10. Terraform"
log_message "11. Stern"
log_message "12. pip (via Homebrew Python)"
log_message "13. pre-commit (via pip)"
log_message "14. Kubernetes Lens"
log_message "15. ggrep"
log_message "16. GitHub CLI (gh) + PR function"
log_message "17. Set up alias (idea)"
log_message "-----------------------------------------------"
